import { addAdmin, deleteAdminById, getAllAdmins, getAdminById, updateAdmin, getMe } from './admin.js'; // Importerar controller-funktionerna från admin.js
...
export async function routes(fastify) {
    ...
    fastify.get('/admin/me', getMe); // ny endpoint
};